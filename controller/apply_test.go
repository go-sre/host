...
func init() {
	defaultLogFn = func(traffic string, start time.Time, duration time.Duration, req *http.Request, resp *http.Response, routeName string, timeout int, limit rate.Limit, burst int, rateThreshold, retry, proxy, proxyThreshold, statusFlags string) {
...
func ExampleEgressApply() {
	...
	//Output:
	//{traffic:egress ,route:* ,request-id:123-456-7890, status-code:0, method:GET, url:urn:postgresql.us-test-1:query.access-log, host:postgresql.us-test-1, path:query.access-log, timeout:-1, rate-limit:-1, rate-burst:-1, rate-threshold:, retry:, proxy:, proxy-threshold:, status-flags:}
...
func ExampleEgressApply_RateLimit() {
	...
	//{traffic:egress ,route:rate-limit-route ,request-id:123-456-7890, status-code:94, method:GET, url:urn:postgresql.us-test-1:query.access-log, host:postgresql.us-test-1, path:query.access-log, timeout:-1, rate-limit:1, rate-burst:0, rate-threshold:, retry:, proxy:, proxy-threshold:, status-flags:RL}
...
func ExampleEgressApply_Timeout() {
	...
	//Output:
	//{traffic:egress ,route:timeout-route ,request-id:123-456-7890, status-code:4, method:GET, url:urn:postgresql.us-test-1:query.access-log, host:postgresql.us-test-1, path:query.access-log, timeout:1000, rate-limit:-1, rate-burst:-1, rate-threshold:, retry:, proxy:, proxy-threshold:, status-flags:UT}
