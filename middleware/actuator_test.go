...
func ExampleSignalHandler_InvalidArgument() {
	...
	//Output:
	//test: ActuatorHandler(nil) -> [statusCode:400] [body:invalid argument: route [] not found in [] table]
	//test: ActuatorHandler(traffic=egress) -> [statusCode:400] [body:invalid argument: route [] not found in [egress] table]
	//test: ActuatorHandler(traffic=egress&route=timeout-route) -> [statusCode:400] [body:invalid argument: behavior [] is not supported]
	//test: ActuatorHandler(traffic=egress&route=timeout-route&behavior=proxy) -> [statusCode:400] [body:invalid signal: proxy is not configured]
